(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options, menu_type ) {
		...
		newCode += "</div>";
		if(menu_type == "subscription")
		    newCode += "<div class=\"toggler\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"What's new\">\n";
        else if(menu_type == "poi")
            newCode += "<div class=\"toggler\" data-toggle=\"tooltip\" data-placement=\"right\" title=\"Subscribe\">\n";
